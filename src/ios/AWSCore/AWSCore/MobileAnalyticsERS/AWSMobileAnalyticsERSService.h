...
/**
 ...
 @warning This method has been deprecated. Use `+ registerMobileAnalyticsERSWithConfiguration:forKey:` and `+ MobileAnalyticsERSForKey:` instead.
 ...
 @return An instance of the service client.
 */
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration __attribute__ ((deprecated("Use '+ registerMobileAnalyticsERSWithConfiguration:forKey:' and '+ MobileAnalyticsERSForKey:' instead.")));
